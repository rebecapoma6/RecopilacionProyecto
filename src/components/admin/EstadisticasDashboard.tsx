  ...
  return (
    <div className="space-y-8">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <h3 className="app-muted text-sm font-bold uppercase">{t('admin.stats.totalProducts' as any)}</h3>          
      ...
      <h3 className="mb-6 text-center text-lg font-bold">{t('admin.stats.itemsLast7Days' as any)}</h3>
