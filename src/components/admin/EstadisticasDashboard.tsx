    ...
    <div className="space-y-8">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <div className="app-surface-strong rounded-2xl border border-l-4 border-l-green-500 p-6 shadow-md">
          <h3 className="app-muted text-sm font-bold uppercase">{t('admin.stats.totalProducts')}</h3>        <p className="mt-2 text-4xl font-extrabold text-green-600">{totalProductos}</p>
        </div>
      </div>

      <div className="app-surface-strong rounded-2xl border p-6 shadow-md">
        <h3 className="mb-6 text-center text-lg font-bold">{t('admin.stats.itemsLast7Days')}</h3>        <div style={{ width: '100%', height: 350 }}>
          <ResponsiveContainer>
